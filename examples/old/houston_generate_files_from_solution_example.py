...
inp_dir = os.path.join(
    os.path.dirname(__file__), "example_data", "ClimateZone2A_Houston", "results"
)
...
solve_options = {
    ...
    "future": {
        "plot_results": plot_results,
        "out_path": os.path.join(
            "example_data", "ClimateZone2A_Houston", "results", "houston_future.png"
        ),
    },
}
...
generate_epw_files(
    ...
    os.path.join(inp_dir, "mews_epw_results"),
    random_seed,
    scen_dict,
    run_parallel,
    num_cpu,
