...
trans_mat = np.array(
    [[1.0 - 2 * p_ee, p_ee, p_ee], [0.15, 0.85, 0.0], [0.15, 0.0, 0.85]]
)
...
wfiles = [
    os.path.join(".", "example_data", "USA_NM_Santa.Fe.County.Muni.AP.723656_TMY3.epw")
]
...
obj = Extremes(
    ...
    results_folder="heat_waves_output",
)
...
fig.text(
    0.01, 0.5, "Dry Bulb Temperature (${^\\circ}C$)", va="center", rotation="vertical"
)
